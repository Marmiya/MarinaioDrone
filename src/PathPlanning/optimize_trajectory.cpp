...
#pragma omp critical
	...
	{
		PointSet3 points;
		CGAL::IO::read_point_set("C:\\Data\\combination\\Sat Jan 22 14 39 22 2022\\finalpts.ply", points);
		std::vector<Viewpoint> initialTraj = read_normal_path("C:\\Data\\combination\\Sat Jan 22 14 39 22 2022\\0.txt");
		pathplanningAdj(points, initialTraj, logPath, mesh, intrinsic_matrix, viewDis, maxAngle, maxViewDis);
